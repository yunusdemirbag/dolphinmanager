...
{settings.imageFiles.length > 0 && (
      ...
      <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 className="text-sm font-medium text-blue-800 mb-2">Etsy Processing Profiles Bilgisi</h3>
        <p className="text-xs text-blue-600">
          Etsy'nin yeni güncellemesi ile tüm ürünler için "Processing Profiles" kullanılmaktadır.
          Otomatik eklenen ürünler için "Made to Order" durumu ve 1-2 günlük işleme süresi ayarlanmıştır.
        </p>
      </div>
